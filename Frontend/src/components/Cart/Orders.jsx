...
import consultation from "../images/consultation-80x80.png";
        ...
        <div className="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg pin-r pin-y md:w-4/5 lg:w-4/5">
          <div className="flex-1">
            <table className="w-full text-sm lg:text-base" cellspacing="0">
              <thead>
                <tr className="h-12 uppercase bg-slate-200">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <a href="#!">
                      <p className="mb-2 md:ml-4">
                        Consultation fee : {`${order2.amount}`}
                        <br />
                        Appointment Date: {`${order2.ddate}`} <br />
                        Time: {`${order2.time}`} <br />
                  ...
                  <td className="hidden text-right md:table-cell">
                    <span className="text-sm lg:text-base font-medium">{`${order2.amount}`}</span>
                  </td>
            ...
            <div className="my-4 mt-6 -mx-2 lg:flex">
              <div className="lg:px-2 lg:w-1/2">
                <div className="p-4 bg-gray-100 rounded-full">
                  <h1 className="ml-2 font-bold uppercase">Coupon Discount</h1>
                </div>
                <div className="p-4">
